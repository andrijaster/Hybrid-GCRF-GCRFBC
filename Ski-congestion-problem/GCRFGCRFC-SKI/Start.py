...
for train_index,test_index in skf.split(atribute, output):
    ...
    Skor_com_MSE[i,:], Skor_com_R2[i,:], Skor_com_R22[i,:], R_train_reg, R_test_reg, R2_reg, Noinst_train, Noinst_test, Y_train_reg, Y_test_reg = Nestrukturni_fun_GCRF(train_index, test_index, Y_test, No_class, testsize2)
    Se_train_reg, Se_test_reg = Struktura_fun_GCRF(No_class, NoGraph, R2_reg, train_index, test_index, Noinst_train, Noinst_test, testsize2, Y_train_reg, Y_test_reg)
